...
## Usage of sankey plot function (see below) [loosely-coupled/dependent] 
#(did not make the function myself, see https://github.com/lcmmichielsen/treeArches-reproducibility/blob/main/Figure3-HLCA%20diseased/sankey.py)
...
###########################################################
#Necessary functions used to create sankey plot (https://github.com/lcmmichielsen/treeArches-reproducibility/blob/main/Figure3-HLCA%20diseased/sankey.py)
